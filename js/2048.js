...
/**
 * Simple 2048 clone based on the 100‑line implementation by ruzhila.cn.  
 * Licensed under the BSD 3‑Clause License.  
 * Source: https://github.com/ruzhila/2048-js (accessed Apr 3, 2026).
 */
class Game { // by ruzhila.cn
    ...
    addNumberAndDraw() {
        ...
        if (available.length === 0) return; // no moves left – game over
    ...
    combind(direction) {
        ...
        if (this.addNumberAndDraw() === undefined) {
            // no moves left; game over flag; handled externally by overriding addNumberAndDraw in the page
        }
    }
}
